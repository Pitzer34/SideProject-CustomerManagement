USE [master]
GO
/****** Object:  Database [CustomerDb]    Script Date: 2023/1/24 下午 04:07:40 ******/
...
USE [CustomerDb]
GO
/****** Object:  User [sa10]    Script Date: 2023/1/24 下午 04:07:40 ******/
CREATE USER [sa10] FOR LOGIN [sa10] WITH DEFAULT_SCHEMA=[dbo]
GO
ALTER ROLE [db_owner] ADD MEMBER [sa10]
GO
/****** Object:  Table [dbo].[Customers]    Script Date: 2023/1/24 下午 04:07:41 ******/
SET ANSI_NULLS ON
GO
